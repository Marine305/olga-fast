	...
	var Lazy = {
		...
		load: function load(state) {
			...
			var callback_loaded = function (element) {
				...
				_.$el && _.$el.trigger('imgLazyLoaded', [_, element]);
			};
			...
			if (!window.LazyLoad) {
				...
				if (_state) {
					...
					var slider_left = _.$el[0].getBoundingClientRect().left + 30;
					var slider_right = _.$el[0].getBoundingClientRect().right + 30;
					// console.log('slider_left', slider_left)
					// console.log('slider_right', slider_right)
					$lazy.each(function (i, el) {
						var $img = $(el);
						// console.log($img.hasClass('fs-slider__img'))
						var img_left = el.getBoundingClientRect().left;
						// console.log(img_left)
						if ($img.hasClass('fs-slider__img')){
						...
						if (!$img.hasClass('fs-slider__img') && img_left >= slider_left && img_left <= slider_right) {
							if (!$img.hasClass('loaded') && !$img.hasClass('loading')) {
								var img_active_lazy_load = new LazyLoad({
									callback_loaded: callback_loaded,
									threshold: 0
